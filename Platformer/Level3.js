  ...
  var createEnemies = function(cenemies){
		...
		cenemies.forEach( function(enemy) {
			switch(enemy.enemyType)
			{
				...
				break;
				case "boss":
					var newEnemy = new Level3Boss(this.game, enemy.position.x, enemy.position.y,level3Boss, level3Boss, 2800,400,100,125,"walking",500,20,25000);
					enemies.push(newEnemy);
				break;
			}
		});
