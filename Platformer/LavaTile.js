var LavaTile = function(game, x, y, image, type, increment, xImageMax, xcountMax, radius, startingState, value) {
	this.game = game;
	this.type = type;
	this.x = x;
	this.y = y;
	...
	render: function(context) {		
		...
		switch(this.state)
		{
			case 'normal':
				...
				context.drawImage(this.sprite_sheet, this.imagex, 0, 16, 16,this.x, this.y, this.radius*2,this.radius*2);
			break;
			case 'captured' :
